...
const Tabone = () => {
    return (
        <div className='pb-14'>
            <div className='flex gap-44 mt-10 border border-gray-600 p-12'>
                <div className="w-1/2">
                    ...
                    <div className='check mt-14 ml-14'>
                        ...
                        <h1 className="text-3xl mt-4 font-bold text-white font-sans">NEED FOR SPEED MATCH PART 2</h1>
                        <p className='text-lg border-gray-600 mt-6'>30TH MAY 2024, 11:00 PM</p>
                    </div>
                </div>
            ...
            <div className='flex gap-44 border border-gray-600 p-12'>
                <div className="w-1/2">
                    <div className='flex gap-8 ml-14'>
                        <h1 className='border border-gray-600 text-lg p-4 text-gray-600'>26 PARTICIPANTS</h1>
                        <h1 className='border border-gray-600 text-lg p-4 text-gray-600'>UPCOMING MATCHES</h1>
                    ...
                    <div className='check mt-14 ml-14'>
                        <h1 className="text-[#0b8ee6] text-2xl ">CHECK OUR ALL</h1>
                        <h1 className="text-3xl mt-4 font-bold text-white font-sans">BACON TENDERLOIN DRUMSTICK MEATBALL</h1>
                        <p className='text-lg border-gray-600 mt-6'>30TH MAY 2024, 11:00 PM</p>
                    </div>
                </div>
                <div className='flex gap-10'>
                    <div className="flex minicard justify-center items-center w-48 h-44 border border-gray-300">
                        <p className="text-white"><img className='h-32' src={pig} alt="" /></p>
                    </div>
                    <button className="flex justify-center items-center w-16 h-16 bg-gray-950 mt-16 text-white rounded-md transition-colors hover:bg-blue-500 ">
                        <span>VS</span>
                    </button>
                    <div className="flex minicard justify-center items-center w-48 h-44 border border-gray-300">
                        <p className="text-white"><img className='h-32' src={rabbit} alt="" /></p>
                    </div>
                </div>
            </div>
            <div className='flex gap-44 border border-gray-600 p-12'>
                <div className="w-1/2">
                    ...
                    <div className='check mt-14 ml-14'>
                        <h1 className="text-[#0b8ee6] text-2xl ">CHECK OUR ALL</h1>
                        <h1 className="text-3xl mt-4 font-bold text-white font-sans">RESIDENT EVIL FINAL CHAPTER BATTLE</h1>
                        <p className='text-lg border-gray-600 mt-6'>30TH MAY 2024, 11:00 PM</p>
                    </div>
                </div>
                <div className='flex gap-10'>
                    <div className="flex minicard justify-center items-center w-48 h-44 border border-gray-300">
                        <p className="text-white"><img className='h-32' src={skull} alt="" /></p>
                    </div>
                    <button className="flex justify-center items-center w-16 h-16 bg-gray-950 mt-16 text-white rounded-md transition-colors hover:bg-blue-500 ">
                        <span>VS</span>
                    </button>
                    <div className="flex minicard justify-center items-center w-48 h-44 border border-gray-300">
                        <p className="text-white"><img className='h-32' src={strategy} alt="" /></p>
                    </div>
                </div>
            </div>
            <div className='flex gap-44 border border-gray-600 p-12'>
                <div className="w-1/2">
                    ...
                    <div className='check mt-14 ml-14'>
                        <h1 className="text-[#0b8ee6] text-2xl ">CHECK OUR ALL</h1>
                        <h1 className="text-3xl mt-4 font-bold text-white font-sans">JUSTICE LEAGUE MATCHES OF POWER</h1>
                        <p className='text-lg border-gray-600 mt-6'>30TH MAY 2024, 11:00 PM</p>
                    </div>
                </div>
                <div className='flex gap-10'>
                    <div className="flex minicard justify-center items-center w-48 h-44 border border-gray-300">
                        <p className="text-white"><img className='h-32' src={cow} alt="" /></p>
                    </div>
                    <button className="flex justify-center items-center w-16 h-16 bg-gray-950 mt-16 text-white rounded-md transition-colors hover:bg-blue-500 ">
                        <span>VS</span>
                    </button>
                    <div className="flex minicard justify-center items-center w-48 h-44 border border-gray-300">
                        <p className="text-white"><img className='h-32' src={gorilla} alt="" /></p>
                    </div>
                </div>
            </div>
        </div>
